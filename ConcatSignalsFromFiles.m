function out = ConcatSignalsFromFiles(varargin)
...
% results = ConcatSignalsFromFiles(...)
%
...
if ~isempty(categoryfun)
  ...
  for k = 1:length(Categories)
    ...
    results1 = ProcessFiles(pathnames1,sourcetype,downsampfactor,nanseparators,names);
