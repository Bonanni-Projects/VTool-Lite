...
%	above all subplots (a "super title"). SUPTITLE('text',FS) 
%       uses a font size of FS. Use this function after all 
%       subplot commands.
...
% Parameter 'fs' added to argument list.  (P.G. Bonanni, 1/29/98)
% Changed handling of 'oldtitle' for compatibility 
% newer Matlab versions (restores ability to change 
% title on subsequent calls).             (P.G. Bonanni, 7/2/20)
